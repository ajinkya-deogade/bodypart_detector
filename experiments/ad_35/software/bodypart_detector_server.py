...
surf = cv2.xfeatures2d.SURF_create(250, nOctaves=2, nOctaveLayers=3)
...
def main(options, args):
    ...
    # bodypart_knn_pos = cv2.flann.Index(bodypart_trained_data_pos.descriptors, dict(algorithm=1, trees=4))
    # bodypart_knn_neg = cv2.flann.Index(bodypart_trained_data_neg.descriptors, dict(algorithm=1, trees=4))
