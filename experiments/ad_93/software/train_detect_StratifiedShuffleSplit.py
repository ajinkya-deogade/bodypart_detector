...
def detect(detect_bodypart, project_dir, train_data_p, train_data_n, test_annotation_list, vote_sigma, vote_patch_size, desc_distance_threshold, vote_threshold, outlier_error_dist, timeStampFolder):
...
if __name__ == '__main__':
    ...
    if train_flag > 0:
        ...
        train_data_positive = '../expts/20170301_224243_onlyMovie_914/python/positive.p'
        train_data_negative = '../expts/20170301_224243_onlyMovie_914/python/negative.p'
        timeStampFolder = '../expts/20170301_224243_onlyMovie_914/python/'
    ...
    detect(detect_bodypart, project_dir, train_data_positive, train_data_negative, test_annotation_list, vote_sigma, vote_patch_size, desc_distance_threshold, vote_threshold, outlier_error_dist, timeStampFolder)