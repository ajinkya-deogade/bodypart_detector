...
./ex_MHhook_detection_train.py --train-annotation-list //Users/agomez/work/dev/mhdo/experiments/ad_2/config/train_annotation_list --project-path /Volumes/HD2/MHDO_Tracking/ --mh-neighborhood 50 --display 1 --trained-knn-file training1.p
