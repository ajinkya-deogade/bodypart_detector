...
def detect(detect_bodypart, project_dir, test_annotation_list, vote_sigma, vote_patch_size, vote_threshold, train_data_p, train_data_n):
...
if __name__ == '__main__':
    ...
    detect(detect_bodypart, project_dir, testListAll, vote_sigma, vote_patch_size, vote_threshold, train_data_p, train_data_n)