...
def main(options, args):
    ...
    newCoordinateFile = os.path.join('../expts/test_results_20160120' + ".json")
...
#        for iteration in range(0, 1000):
            ...
            for s in range(0, n_server):
                if ( not server_free[s] ):
                    ...
                    try:
                        ...
                        received_json["FrameFile"] = frame_file_0
                        print "Frame File :",received_json["FrameFile"]
                        received_detections[str(j).rjust(6,'0')] = received_json
    ...
    print "Data processed :", os.sys.argv
    ...
    json.dump(received_detections, fileWriter_newCoordinates, sort_keys=True, indent=4, separators=(',', ': '))
