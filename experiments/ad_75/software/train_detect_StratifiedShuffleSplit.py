...
def detect(detect_bodypart, project_dir, train_data_p, train_data_n, test_annotation_list, vote_sigma, vote_patch_size, desc_distance_threshold, vote_threshold, outlier_error_dist):
    ...
    testData = {}
    testData["AllDetections"] = {}

    for j in range(0, len(test_annotations)):
        frame_index += 1
        testData["AllDetections"][frame_index] = {}
        os.system('clear')
        ...
        for bi in detect_bodypart:
            print bi
            testData["AllDetections"][frame_index][bi] = {}
            testData["AllDetections"][frame_index][bi]["detected_x"] = -1
            testData["AllDetections"][frame_index][bi]["detected_y"] = -1
            testData["AllDetections"][frame_index][bi]["confidence"] = -1
            testData["AllDetections"][frame_index][bi]["annotated_x"] = -1
            testData["AllDetections"][frame_index][bi]["annotated_y"] = -1
            testData["AllDetections"][frame_index][bi]["distance"] = -1
        ...
        if ( "detections" in received_json ):
            for di in range(0, len(received_json["detections"])):
                ...
                testData["AllDetections"][frame_index][tbp]["detected_x"] = received_json["detections"][di]["coord_x"]
                testData["AllDetections"][frame_index][tbp]["detected_y"] = received_json["detections"][di]["coord_y"]
                testData["AllDetections"][frame_index][tbp]["confidence"] = received_json["detections"][di]["conf"]
                ...
                if ( tbp in bodypart_gt[fi]["bodypart_coords_gt"] ):
                    ...
                    testData["AllDetections"][frame_index][tbp]["annotated_x"] = bodypart_gt[fi]["bodypart_coords_gt"][tbp]["x"]
                    testData["AllDetections"][frame_index][tbp]["annotated_y"] = bodypart_gt[fi]["bodypart_coords_gt"][tbp]["y"]
                    testData["AllDetections"][frame_index][tbp]["distance"] = error_stats.error_distance
...
if __name__ == '__main__':
    ...
    if train_flag > 0:
        ...
        train_data_positive = '../expts/20160505_213143_fragmented/positive.p'
        train_data_negative = '../expts/20160505_213143_fragmented/negative.p'
