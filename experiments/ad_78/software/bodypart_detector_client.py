        ...
        if(cap.isOpened()):
            ...
            for k in range(0, len(annotation)):
                ...
                for j in range(0, len(annotation[k]["FrameValueCoordinates"])):
                    if (annotation[k]["FrameValueCoordinates"][j]["Name"] == test_bodypart and annotation[k]["FrameValueCoordinates"][j]["Value"]["x_coordinate"] != -1 and annotation[k]["FrameValueCoordinates"][j]["Value"]["y_coordinate"] != -1):
                        bodypart_coords_gt = {}
                        bodypart_coords_interpolated = {}
                        bodypart_coords_gt["x"] = int(annotation[k]["FrameValueCoordinates"][j]["Value"]["x_coordinate"])
                        bodypart_coords_gt["y"] = int(annotation[k]["FrameValueCoordinates"][j]["Value"]["y_coordinate"])
                        if k > 0 and k < len(annotation)-1:
                            # print "K: ", k
                            bodypart_coords_interpolated["x"] = int((annotation[k-1]["FrameValueCoordinates"][j]["Value"]["x_coordinate"] + annotation[k+1]["FrameValueCoordinates"][j]["Value"]["x_coordinate"])/2)
                            bodypart_coords_interpolated["y"] = int((annotation[k-1]["FrameValueCoordinates"][j]["Value"]["y_coordinate"] + annotation[k+1]["FrameValueCoordinates"][j]["Value"]["y_coordinate"])/2)
                        else:
                            bodypart_coords_interpolated["x"] = int(annotation[k]["FrameValueCoordinates"][j]["Value"]["x_coordinate"])
                            bodypart_coords_interpolated["y"] = int(annotation[k]["FrameValueCoordinates"][j]["Value"]["y_coordinate"])
                ...
                bodypart_gt[frame_index]["video_file"] = {}
                bodypart_gt[frame_index]["bodypart_coords_gt"] = bodypart_coords_gt
                bodypart_gt[frame_index]["bodypart_coords_interpolated"] = bodypart_coords_interpolated
