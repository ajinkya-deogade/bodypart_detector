...
def get_train_features(annotation, options):
    ...
    print"training_bodypart:     ",training_bodypart
...
def main(options, args):
    ...
    results = process_pool.map(get_train_features, train_annotation["Annotations"], options)
