...
if __name__ == '__main__':
    ...
    factor = len(bodypart_vote_train_neg)/len(bodypart_vote_train_pos)
    bodypart_kp_train_neg, bodypart_desc_train_neg, bodypart_vote_train_neg = zip(*random.sample(zip(bodypart_kp_train_neg, bodypart_desc_train_neg, bodypart_vote_train_neg), len(bodypart_vote_train_neg)/int(factor)))
