...
def stampAnnotations(video_file, project_dir, plot_body_part, spot_size):
    ...
    print os.listdir(os.path.join(os.path.abspath(head), os.path.splitext(tail)[0]))
    trackerMetadataFile = [name for name in os.listdir(os.path.join(os.path.abspath(head), os.path.splitext(tail)[0])) if name.endswith('.txt')]
    ...
    for row in range(0, numberFramesTrackerRecorded):
        ...
        if ~(np.any(np.isnan(trackerMetaData[row, :]))):
            ...
            detectedBodyPart['Head']['spot_size'] = spot_size
            ...
            detectedBodyPart['Tail']['spot_size'] = spot_size
            ...
            detectedBodyPart['MouthHook']['spot_size'] = spot_size
            ...
            detectedBodyPart['LeftMHhook']['spot_size'] = spot_size
            ...
            detectedBodyPart['RightMHhook']['spot_size'] = spot_size
            ...
            detectedBodyPart['LeftDorsalOrgan']['spot_size'] = spot_size
            ...
            detectedBodyPart['RightDorsalOrgan']['spot_size'] = spot_size
    ...
    frameNumber = 0
    if numberFrames > 1200:
        numberFrames = 1200

    for ijk in range(0, numberFrames):
    # for frameInfo in AllDetectedBodyPart:
        frameInfo = AllDetectedBodyPart[ijk]
        actualIndex = frameInfo['FrameNumber'] - firstFrame
        ...
        if cap.isOpened():
            try:
                ...
                # if fpgaBodyPartInfo['conf'] >= confThreshold:
                    ...
                    if bp == 'LeftDorsalOrgan' and frameInfo[bp]['conf'] >= 20:
                    ...
                    elif bp == 'RightDorsalOrgan' and frameInfo[bp]['conf'] >= 20:
                    ...
                    elif bp == 'MouthHook' and frameInfo[bp]['conf'] >= 20:
...
if __name__ == '__main__':
    ...
    parser.add_option("", "--spot-size", dest="spot_size", type="int", help="path containing data directory")
    ...
    stampAnnotations(video_file, options.project_dir, options.body_part, options.spot_size)