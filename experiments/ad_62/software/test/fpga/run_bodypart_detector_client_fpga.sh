...
mkdir -vp ../../../expts
mkdir -vp ../../../expts/save_images

time ./bodypart_detector_client_fpga.py --test-annotation-list ../../../config/forTesting/test_annotation_list --project-path "${PROJECT_PATH}/" --display 1 --outlier-error-dist 15 --n-server 1 --test-bodypart MouthHook --verbosity 1 --crop-size 256 --dir-keypoints "${KEYPOINTS_DIR}/" --dir-descriptor "${DESCRIPTORS_DIR}/" --port-number 10000 --save-dir ../../../expts/save_images
